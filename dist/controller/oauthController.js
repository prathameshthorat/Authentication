    ...
    function OauthController() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (errors)
                            throw errors;
                        return [4 /*yield*/, user_1.model.findOne({ "username": req.body.username }).exec()];
                    case 1:
                        user = _a.sent();
                        if (user === null)
        ...
        this.getStrategy = function () {
            ...
            return new passport_jwt_1.Strategy(params, function (req, payload, done) {
                user_1.model.findOne({ "username": payload.username }, function (err, user) {
